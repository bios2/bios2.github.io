...
## The data
*describe Lucas's dataset*

*explain that it is stored in a list*

*explain that each element is the matrix for a university where rows and columns are researchers, nodes are shared publications*

*teach the different ways of indexing lists, getting names (i.e., university names)*
...
*for our shiny app, we want to be able to plot the collaboration network for a university that the user selects. we will learn how to write a function that creates a plot for a selected university*
